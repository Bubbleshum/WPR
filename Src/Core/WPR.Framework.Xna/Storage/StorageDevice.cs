...
namespace Microsoft.Xna.Framework.Storage
{
	...
	public sealed class StorageDevice
	{
		...
		private static readonly string storageRoot = XnaBackend.Storage.GetStorageRoot();
		private static readonly DriveInfo drive = XnaBackend.Storage.GetDriveInfo(storageRoot);
