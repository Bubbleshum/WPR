...
#pragma warning restore 0067
		...
		public RenderTargetCube(
			...
			MultiSampleCount = XnaBackend.Graphics.GetMaxMultiSampleCount(
			...
			{
				glColorBuffer = XnaBackend.Graphics.GenColorRenderbuffer(
					graphicsDevice.GLDevice,
					Size,
					Size,
					Format,
			...
			glDepthStencilBuffer = XnaBackend.Graphics.GenDepthStencilRenderbuffer(
				graphicsDevice.GLDevice,
				Size,
				Size,
				DepthStencilFormat,
		...
		protected override void Dispose(bool disposing)
		{
			if (!IsDisposed)
			{
				...
				{
					XnaBackend.Graphics.AddDisposeRenderbuffer(
						GraphicsDevice.GLDevice,
						glColorBuffer
					);
				}
