...
namespace Microsoft.Xna.Framework.Graphics
{
	...
	public class PresentationParameters
	{
		...
		internal RhiPresentationParameters parameters;
		...
		public PresentationParameters()
		{
			...
			BackBufferWidth = 800;  // GraphicsDeviceManager.DefaultBackBufferWidth (inlined; the manager stays in FNA)
			BackBufferHeight = 480; // GraphicsDeviceManager.DefaultBackBufferHeight (inlined)
