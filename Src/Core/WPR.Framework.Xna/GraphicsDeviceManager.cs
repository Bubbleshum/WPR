...
namespace Microsoft.Xna.Framework
{
	public class GraphicsDeviceManager : IGraphicsDeviceService, IDisposable, IGraphicsDeviceManager
	{
		...
		public GraphicsDeviceManager(Game game)
		{
			...
			supportsOrientations = WPR.Xna.Rhi.XnaBackend.Platform.SupportsOrientationChanges();
		...
		private void INTERNAL_OnClientSizeChanged(object sender, EventArgs e)
		{
			...
			WPR.Xna.Rhi.XnaBackend.Platform.ScaleForWindow(
				window.Handle,
				true,
		...
		private void INTERNAL_CreateGraphicsDeviceInformation(
			...
			else if (gdi.PresentationParameters.MultiSampleCount == 0)
			{
				...
				if (graphicsDevice != null)
				{
					maxMultiSampleCount = WPR.Xna.Rhi.XnaBackend.Graphics.GetMaxMultiSampleCount(
